# -*- encoding: utf-8 -*-
# stub: awesome_nested_set 3.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord>.freeze, ["< 5.1", ">= 4.0.0"])
      s.add_development_dependency(%q<rspec-rails>.freeze, ["= 3.5.0.beta3"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10"])
      s.add_development_dependency(%q<combustion>.freeze, [">= 0.5.2"])
      s.add_development_dependency(%q<database_cleaner>.freeze, [">= 0"])
    else
      s.add_dependency(%q<activerecord>.freeze, ["< 5.1", ">= 4.0.0"])
      s.add_dependency(%q<rspec-rails>.freeze, ["= 3.5.0.beta3"])
      s.add_dependency(%q<rake>.freeze, ["~> 10"])
      s.add_dependency(%q<combustion>.freeze, [">= 0.5.2"])
